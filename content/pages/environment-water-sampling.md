---
title: Water Sampling Program
description: Learn about our water quality monitoring program.
---

The water quality at Lake Bernard has been regularly monitored over the years with the earliest report we have dating from 1986. This monitoring is an important part of our Environmental Stewardship campaign and since 2018 a team of volunteers has used a grant from La Peche to conduct bi-annual testing. Today's sampling tests for e.coli bacteria** and total phosphorous* at 24 sites around the lake. The sampling sites are shown on the lake map below.

<img src="/images/sampling-sites-map.jpg" alt="Water sampling sites map" style="width: 100%; height: auto; margin: 1.5rem 0;" />

#### <a href="https://drive.google.com/file/d/1iNJkFO9-qVhDt90Z3GDX2TpI6j94Bmse/view?usp=sharing" target="_blank" rel="noopener noreferrer">Report on Water Quality Sampling 2023</a>
...
### 1. Monitor Long Term Water Quality
...
### 2. Monitor Water Quality for Recreational Purposes

Cottagers want to be assured that the lake is safe for swimming and boating. As such, samples were taken by the Lake Association's Environment Committee three times each summer at 24 sites shown on the map of sampling sites. Samples were taken to check for fecal coliform or e.coli, total phosphorous and transparency. The analysis of this testing was covered thanks to an environment grant from the municipality of La Pêche, and results were reported on the Lake Association website.

### 3. Monitor Effects of Pollution Sources on Water Quality

Pollution from septic systems can leak into the water where cottagers swim. To monitor this pollution, the Lake Association checked e.coli levels along the shoreline in front of almost 400 cottages in 2008. In 2011, and for the following three years, water was sampled again in front of one-quarter of the properties on the lake. This sampling was paid for by the Lake Association and reported on the Lake Association website.

\* Total Phosphorus (TP) at Lac Bernard should be between 0.00 – 0.010 miligrams per litre (mg/l). At 0.015 mg/l and over, algae blooms are possible and weed growth will increase.

\*\* E. coli bacteria is monitored for swimming and not for drinking water quality. Quebec classifies water quality as excellent when the levels of e. coli are 0-20 and all recreational activities are permitted. Fecal coliform includes e.coli as well as other bacteria.
