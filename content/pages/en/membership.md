---
title: Membership
description: Learn about Lac Bernard Association membership and manage it in the online member area.
---

## Membership Fees

Membership is **$75** per year for voting members and **$25** per year for associate members.
...
**Enrollment, renewal, and payment** are handled in the [**online member area**](/en/membership/account). You will be prompted to **sign in or create an account** when needed. Use the **email address the association already has on file** when you sign in so the site can connect you to your member record. There you can check your membership status, keep your contact details up to date, and start or renew membership for the year.

You can also reach us at [membership@lacbernard.ca](mailto:membership@lacbernard.ca).
...
- Work with all levels of government to preserve and enhance the state of the lake and its biodiversity, ensure the maintenance of access roads and support the delivery of common services to residents and owners
- Support the recreational interests for the members of the Corporation
- Encourage the development of a respectful, involved and convivial community
- Ensure the Corporation is managed with fiscal responsibility, good governance and probity
...
- Annually testing water quality for bacteria and phosphates, and monitoring shoreline over-development
...
<a href="/en/membership/account" class="btnPrimary">Go to your member account</a>
</div>
