...
revoke all on function public.zero_stripe_payment_after_reversal(p_payment_intent_id text) from public;
grant execute on function public.zero_stripe_payment_after_reversal(p_payment_intent_id text) to service_role;
comment on function public.zero_stripe_payment_after_reversal(p_payment_intent_id text) is
