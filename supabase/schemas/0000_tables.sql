...
create table if not exists "public"."payments" (
    ...
    constraint "payments_donation_category_zero_check" check ((("donation_amount" > (0)::numeric) or ("donation_category" is null)))
);
...
comment on column "public"."payments"."donation_category" is 'Donation fund category: environment, regatta, or general. Null when no donation portion (or legacy rows).';
