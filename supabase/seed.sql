...
insert into public.memberships (id, member_id, year, tier, status, created_at) values
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-000000000022'::uuid, 'aaaaaaaa-aaaa-4aaa-8aaa-00000000000b'::uuid, 2026, 'general', 'pending', '2026-03-28T10:00:00Z'::timestamptz),
  ('aaaaaaaa-aaaa-4aaa-8aaa-000000000023'::uuid, 'aaaaaaaa-aaaa-4aaa-8aaa-00000000000c'::uuid, 2025, 'general', 'active', '2025-09-01T12:00:00Z'::timestamptz);
